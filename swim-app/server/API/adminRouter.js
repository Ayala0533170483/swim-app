...
router.get('/:type', async (req, res) => {
    try {
        ...
        const items = await adminController.getItems(type, filters);
...
router.post('/:type', async (req, res) => {
    try {
        ...
        const newItem = await adminController.createItem(type, itemData);
...
router.delete('/:type/:id', async (req, res) => {
    try {
        ...
        const result = await adminController.deleteItem(type, id);
