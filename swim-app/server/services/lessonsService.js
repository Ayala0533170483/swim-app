...
async function getMyLessons({ role, id }) {
    ...
    try {
        ...
        const [rows] = await conn.query(sql, [role, id, role, id]);
...
async function getTeacherLessonsForDate(teacherId, lessonDate) {
    ...
    try {
        ...
        const [rows] = await conn.query(sql, [teacherId, lessonDate]);
...
async function getStudentLessonsForDate(studentId, lessonDate) {
    ...
    try {
        ...
        const [rows] = await conn.query(sql, [studentId, lessonDate]);
